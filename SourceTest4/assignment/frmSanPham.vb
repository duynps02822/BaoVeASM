...
Public Class frmSanPham
    ...
    'Dim chuoiketnoi As String = "Data Source=.;Initial Catalog=PS02822;Integrated Security=True"
    Dim chuoiketnoi As String = "workstation id=QLBanHang.mssql.somee.com;packet size=4096;user id=duynps02822_SQLLogin_1;pwd=xsqz5k623l;data source=QLBanHang.mssql.somee.com;persist security info=False;initial catalog=QLBanHang"
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        conn.Open()
        Dim refesh As SqlDataAdapter = New SqlDataAdapter("select MaSP as 'Mã SP' ,TenSP as 'Tên Sản phẩm', SoLuong as 'Số lượng', Dongia as 'Đơn giá', SoLuong * Dongia as 'Thành tiền' from San_Pham1", conn)
        db.Clear()
        refesh.Fill(db)
    ...
    Private Sub btnLuu_Click(sender As Object, e As EventArgs) Handles btnLuu.Click
        ...
        Else
            Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
            Dim query As String = "insert into San_Pham1 values(@MASP,@TENSP,@SOLUONG,@DONGIA)"
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        If txtMaSP.Text = "" Then
            ...
            txtMaSP.Focus()
        Else
            Dim delquery As String = "delete from San_Pham1 where MaSP=@MASP"
    ...
    Private Sub btnSua_Click(sender As Object, e As EventArgs) Handles btnSua.Click
        ...
        ElseIf btnSua.Text = "Update" Then
            Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
            Dim query As String = "update San_Pham1 set TenSP=@TENSP, SoLuong=@SOLUONG, Dongia=@DONGIA where MaSP=@MASP"
            Dim save As SqlCommand = New SqlCommand(query, conn)
            conn.Open()
            save.Parameters.AddWithValue("@MASP", txtMaSP.Text)
            save.Parameters.AddWithValue("@TENSP", txtTenSP.Text)
